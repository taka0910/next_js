...
export default function UserProfile() {
  ...
  const [profile, setProfile] = useState({
    ...
    hometown: "東京都",
    job: "デザイナー",
    hobbies: ["読書", "映画鑑賞", "カフェ巡り", "写真撮影"],
    favoriteFood: "パスタ、スイーツ",
    favoriteColor: "ピンク",
    dreamDestination: "フランス",
  })
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-pink-100 sticky top-0 z-50">
        <div className="max-w-md mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <BackButton />
            <h1 className="font-bold text-lg text-gray-800">あなたのプロフィール</h1>
            <Button
          ...
          <CardContent className="p-6 text-center">
            <div className="relative inline-block">
              <Avatar className="w-24 h-24 mx-auto mb-4">
                ...
                <AvatarFallback className="bg-pink-200 text-pink-700 text-2xl">あ</AvatarFallback>
              </Avatar>
              {isEditing && (
